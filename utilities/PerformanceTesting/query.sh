...
get_reports_for_collector_timers() {
    ...
    total_max_time=0
    total_avg_time=0
    for timer in net_scrape_update net_scrape_read net_write_message net_create_message; do
...
get_reports_for_collector_counters() {
    ...
    for counter in net_conn_deltas net_conn_updates net_conn_inactive; do
